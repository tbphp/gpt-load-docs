...
export default function ArchitecturePageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">{t('architectureDesign.title')}</h1>
      ...
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.overview.title')}</h2>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">{t('architectureDesign.components.apiGateway.title')}</h3>
            <p className="text-gray-600 text-sm">{t('architectureDesign.components.apiGateway.description')}</p>
          </div>
          <div className="text-center">
            <div className="bg-green-100 p-4 rounded-lg mb-3 mx-auto w-16 h-16 flex items-center justify-center">
              <Server className="h-8 w-8 text-green-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">{t('architectureDesign.components.loadBalancer.title')}</h3>
            <p className="text-gray-600 text-sm">{t('architectureDesign.components.loadBalancer.description')}</p>
          </div>
          <div className="text-center">
            <div className="bg-purple-100 p-4 rounded-lg mb-3 mx-auto w-16 h-16 flex items-center justify-center">
              <Database className="h-8 w-8 text-purple-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">{t('architectureDesign.components.dataStorage.title')}</h3>
            <p className="text-gray-600 text-sm">{t('architectureDesign.components.dataStorage.description')}</p>
          </div>
          <div className="text-center">
            <div className="bg-red-100 p-4 rounded-lg mb-3 mx-auto w-16 h-16 flex items-center justify-center">
              <Shield className="h-8 w-8 text-red-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">{t('architectureDesign.components.securityMonitor.title')}</h3>
            <p className="text-gray-600 text-sm">{t('architectureDesign.components.securityMonitor.description')}</p>
          </div>
        </div>
      </div>
      ...
      {/* System Components */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.systemComponents.title')}</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('architectureDesign.systemComponents.coreService.loadBalancer.title')}</h4>
                <ul className="text-gray-600 space-y-1 text-sm">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('architectureDesign.systemComponents.managementLayer.restApi.title')}</h4>
                <ul className="text-gray-600 space-y-1 text-sm">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('architectureDesign.systemComponents.dataLayer.redis.title')}</h4>
                <ul className="text-gray-600 space-y-1 text-sm">
      ...
      {/* Data Flow */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.dataFlow.title')}</h2>
      ...
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.deploymentArchitectures.title')}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <h4 className="font-semibold text-green-900 mb-2">{t('architectureDesign.deploymentArchitectures.standalone.scenarios.title')}</h4>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
              <h4 className="font-semibold text-blue-900 mb-2">{t('architectureDesign.deploymentArchitectures.cluster.scenarios.title')}</h4>
      ...
      {/* Technology Stack */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.techStack.title')}</h2>

        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 className="font-semibold text-blue-900 mb-4">{t('architectureDesign.techStack.backend.title')}</h3>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <h3 className="font-semibold text-green-900 mb-4">{t('architectureDesign.techStack.frontend.title')}</h3>
            <ul className="space-y-2">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
            <h3 className="font-semibold text-purple-900 mb-4">{t('architectureDesign.techStack.infrastructure.title')}</h3>
            <ul className="space-y-2">
      ...
      {/* Design Principles */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('architectureDesign.designPrinciples.title')}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">{t('architectureDesign.designPrinciples.highPerformance.title')}</h3>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">{t('architectureDesign.designPrinciples.highAvailability.title')}</h3>
                <p className="text-gray-600 text-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">{t('architectureDesign.designPrinciples.scalability.title')}</h3>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">{t('architectureDesign.designPrinciples.transparentProxy.title')}</h3>
                <p className="text-gray-600 text-sm">
