...
export default function SourcePageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">{t("deployment.source.title")}</h1>
      ...
      {/* Prerequisites */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("deployment.source.prerequisites.title")}</h2>

        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start space-x-2">
            <Code className="h-5 w-5 text-blue-600 mt-0.5" />
            <div>
              <h4 className="font-semibold text-blue-900">{t("deployment.source.prerequisites.development.title")}</h4>
      ...
      {/* Installation Steps */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("deployment.source.installation.title")}</h2>
        ...
        <div className="space-y-8">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="mb-4">
              <p className="text-gray-700 mb-2">{t("deployment.source.installation.step2.description")}</p>
              <div className="bg-gray-900 text-gray-100 p-4 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-gray-700 text-sm mb-1">{t("deployment.source.installation.step3.database.mysql")}：</p>
                    <div className="bg-gray-100 p-2 rounded text-sm">
                      <code>
                  ...
                  <div>
                    <p className="text-gray-700 text-sm mb-1">{t("deployment.source.installation.step3.database.postgresql")}：</p>
                    <div className="bg-gray-100 p-2 rounded text-sm">
                      <code>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("deployment.source.installation.step4.frontend.title")}</h4>
                <div className="bg-gray-900 text-gray-100 p-4 rounded-lg mb-2">
                  <code className="text-sm">
      ...
      {/* Development Guide */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("deployment.source.development.title")}</h2>
      ...
      {/* Troubleshooting */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("deployment.source.troubleshooting.title")}</h2>
        ...
        <div className="space-y-6">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800">{t("deployment.source.troubleshooting.common.goVersion.title")}</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-800">{t("deployment.source.troubleshooting.common.dependency.title")}</h4>
                <p className="text-gray-600 text-sm mb-2">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-violet-50 border border-blue-200 rounded-xl p-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t("deployment.source.nextSteps.title")}</h2>
        <p className="text-gray-700 mb-6">{t("deployment.source.nextSteps.description")}</p>
