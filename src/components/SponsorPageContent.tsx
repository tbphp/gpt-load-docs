    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">{t("sponsor.title")}</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600">{t("sponsor.paymentMethods.wechat.description")}</p>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600">{t("sponsor.paymentMethods.alipay.description")}</p>
            </div>
            <div className="flex justify-center mb-6">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <Image
      ...
      <div className="mb-12">
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">{t("sponsor.onlinePlatform.title")}</h2>
        </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-8 text-center">
        <div className="flex items-center justify-center mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">{t("sponsor.thankYou.title")}</h2>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600">
          {tArray("sponsor.thankYou.tags").map((tag: string, index: number) => (
            <span key={index} className="bg-white px-4 py-2 rounded-full border border-gray-200">
              {tag}
            </span>
          ))}
        </div>
