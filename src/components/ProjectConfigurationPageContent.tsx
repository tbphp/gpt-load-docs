    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6">
          <Database className="inline h-6 w-6 mr-2 text-orange-600 dark:text-orange-400" />
        ...
        <div className="space-y-8">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td className="py-2 px-3">
                      <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">app_url</code>
                    </td>
                  ...
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td className="py-2 px-3">
                      <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">proxy_keys</code>
                    </td>
          ...
          <div className="border border-amber-200 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20 rounded-lg p-6">
            ...
            <div className="mb-4">
              ...
              <div className="bg-amber-100 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-600 rounded p-3">
                <code className="text-amber-900 dark:text-amber-300 font-semibold">
      ...
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6">
          <Key className="inline h-6 w-6 mr-2 text-green-600 dark:text-green-400" />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 space-y-1 text-sm">
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">request_timeout</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.requestTimeout")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">connect_timeout</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.connectTimeout")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">idle_conn_timeout</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.idleConnTimeout")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">response_header_timeout</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.responseHeaderTimeout")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">max_idle_conns</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.maxIdleConns")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">max_idle_conns_per_host</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.maxIdleConnsPerHost")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">proxy_url</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.requestConnection.proxyUrl")}
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 space-y-1 text-sm">
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">max_retries</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.maxRetries")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">blacklist_threshold</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.blacklistThreshold")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">key_validation_interval_minutes</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.keyValidationInterval")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">key_validation_concurrency</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.keyValidationConcurrency")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">key_validation_timeout_seconds</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.keyValidationTimeout")}
                  </li>
                  <li>
                    • <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">enable_request_body_logging</code> - {t("projectConfigurationPage.groupConfiguration.overridableSettings.keyManagement.enableRequestBodyLogging")}
                  </li>
                </ul>
              </div>
            </div>
