...
export default function QuickStartPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">{t('docsQuickStart.title')}</h1>
      ...
      {/* Quick Start Section */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t('docsQuickStart.quickLaunch.title')}</h2>

        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <div className="flex items-start space-x-2">
            <Zap className="h-5 w-5 text-green-600 mt-0.5" />
            <div>
              <h4 className="font-semibold text-green-900">{t('docsQuickStart.quickLaunch.lightweightDeployment.title')}</h4>
        ...
        {/* Prerequisites */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">{t('docsQuickStart.requirements.title')}</h3>
        ...
        {/* Installation Steps */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">{t('docsQuickStart.installation.title')}</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <p className="text-gray-700 mb-2">{t('docsQuickStart.steps.verify.accessAdmin')}:</p>
                  <a
        ...
        {/* Common Commands */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">{t('docsQuickStart.commands.title')}</h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 mb-2">{t('docsQuickStart.commands.checkStatus')}</h4>
              <code className="text-sm text-gray-700">docker compose ps</code>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 mb-2">{t('docsQuickStart.commands.viewLogs')}</h4>
              <code className="text-sm text-gray-700">
                docker compose logs -f
              </code>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 mb-2">{t('docsQuickStart.commands.restart')}</h4>
              <code className="text-sm text-gray-700">
                docker compose down && docker compose up -d
              </code>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 mb-2">{t('docsQuickStart.commands.update')}</h4>
              <code className="text-sm text-gray-700">
