    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center mb-4">
          <Users className="h-12 w-12 text-blue-600 dark:text-blue-400 mr-3" />
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-8 mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm">{t("contributors.thanks.note")}</p>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 text-center">
          {!imageError ? (
            ...
            <div className="flex flex-col items-center justify-center h-32 bg-gray-50 dark:bg-gray-900 rounded-lg">
              <Github className="h-12 w-12 text-gray-600 dark:text-gray-400 mb-2" />
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-800 dark:text-blue-300 dark:hover:text-blue-200 transition-colors duration-200 flex items-center"
              >
