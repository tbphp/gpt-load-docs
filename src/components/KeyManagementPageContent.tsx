...
export default function KeyManagementPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">{t('keyManagement.title')}</h1>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('keyManagement.polling.objective.title')}</h3>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-gray-900 font-medium">{t('keyManagement.polling.implementation.atomicCounter.title')}</p>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-900 font-medium">{t('keyManagement.polling.implementation.statusFilter.title')}</p>
                    <p className="text-gray-600 text-sm">
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900">{t('keyManagement.retry.process.step1.title')}</h5>
                  <p className="text-gray-600 text-sm">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900">{t('keyManagement.retry.process.step2.title')}</h5>
                  <p className="text-gray-600 text-sm">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900">{t('keyManagement.retry.process.step3.title')}</h5>
                  <p className="text-gray-600 text-sm">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900">{t('keyManagement.retry.process.step4.title')}</h5>
                  <p className="text-gray-600 text-sm">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">{t('keyManagement.blacklist.mechanism.trigger.title')}</h4>
                  <p className="text-gray-600 text-sm">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">{t('keyManagement.blacklist.mechanism.actions.title')}</h4>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">{t('keyManagement.recovery.timing.title')}</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">{t('keyManagement.recovery.process.title')}</h4>
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-6">{t('keyManagement.advantages.title')}</h2>
        <div className="bg-gradient-to-br from-blue-50 to-green-50 border border-blue-200 rounded-lg p-6">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{t('keyManagement.advantages.loadBalancing.title')}</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{t('keyManagement.advantages.autoRecovery.title')}</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{t('keyManagement.advantages.faultIsolation.title')}</h3>
              <p className="text-gray-600 text-sm">
