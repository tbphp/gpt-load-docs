    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-4 mb-8">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-medium text-amber-900 dark:text-amber-200 mb-1">{t("cloudflareAIGateway.importantNotice.title")}</h3>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step2.navigation.selectMenu.title")}</p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm" dangerouslySetInnerHTML={{ __html: t("cloudflareAIGateway.step2.navigation.selectMenu.description") }} />
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step2.navigation.accessPage.title")}</p>
            ...
            {/* 右侧图片 */}
            <div className="bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-6 lg:border-l border-gray-200 dark:border-gray-700">
              <ImageViewer
                src="/int_cf_001.png"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-gray-900 dark:text-white font-medium mb-2">{t("cloudflareAIGateway.step3.createButton.title")}</p>
                <p className="text-gray-600 dark:text-gray-400 text-sm" dangerouslySetInnerHTML={{ __html: t("cloudflareAIGateway.step3.createButton.description") }} />
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step3.configuration.gatewayName.title")}</p>
                      <div className="bg-gray-100 dark:bg-gray-800 rounded-md p-3 mt-2">
                        <code className="text-sm text-gray-800 dark:text-gray-200">gpt-load</code>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-xs mt-1" dangerouslySetInnerHTML={{ __html: t("cloudflareAIGateway.step3.configuration.gatewayName.note") }} />
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step3.configuration.defaultSettings.title")}</p>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <ul className="text-amber-800 dark:text-amber-300 text-xs mt-1 space-y-1">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step4.endpoint.clickAPI.title")}</p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm" dangerouslySetInnerHTML={{ __html: t("cloudflareAIGateway.step4.endpoint.clickAPI.description") }} />
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step4.endpoint.selectChannel.title")}</p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-gray-900 dark:text-white font-medium">{t("cloudflareAIGateway.step5.configuration.copyAddress.title")}</p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-xs mt-2" dangerouslySetInnerHTML={{ __html: t("cloudflareAIGateway.step5.configuration.example.explanation") }} />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mb-12">
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-6">
          <div className="flex items-start space-x-3">
            <AlertCircle className="h-5 w-5 text-amber-600 flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-medium text-amber-900 dark:text-amber-200 mb-2">{t("cloudflareAIGateway.geminiNotice.reminder")}</h3>
              <div className="text-amber-800 dark:text-amber-300 text-sm space-y-2">
      ...
      <section className="mb-12">
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-6">
          <div className="flex items-start space-x-3">
            <AlertCircle className="h-5 w-5 text-amber-600 flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-medium text-amber-900 dark:text-amber-200 mb-2">{t("cloudflareAIGateway.networkNotice.regionalBlock")}</h3>
              <div className="text-amber-800 dark:text-amber-300 text-sm space-y-2">
                <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">{t("cloudflareAIGateway.verification.title")}</h2>
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-medium text-green-900 dark:text-green-200 mb-1">{t("cloudflareAIGateway.verification.testConnection")}</h3>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t("cloudflareAIGateway.relatedResources.title")}</h3>
