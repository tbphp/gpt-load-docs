...
export default function ClawCloudPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
            ...
            <div>
              ...
              <div className="text-red-800 space-y-2">
                ...
                <div className="mt-4 p-3 bg-red-100 rounded border">
                  <p className="font-semibold text-red-900">{t("clawCloud.warning.recommendation.title")}</p>
      ...
      {/* Overview */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("clawCloud.overview.title")}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">{t("clawCloud.overview.features.freeQuota.title")}</h3>
            <p className="text-gray-600 text-sm">{t("clawCloud.overview.features.freeQuota.description")}</p>
          </div>
          <div className="text-center">
            <div className="bg-blue-100 p-4 rounded-lg mb-3 mx-auto w-16 h-16 flex items-center justify-center">
              <Globe className="h-8 w-8 text-blue-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">{t("clawCloud.overview.features.globalDeploy.title")}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">{t("clawCloud.overview.features.simpleAuth.title")}</h3>
            <p className="text-gray-600 text-sm">
      ...
      {/* Prerequisites */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("clawCloud.prerequisites.title")}</h2>

        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          <div className="flex items-start space-x-2">
            <AlertTriangle className="h-5 w-5 text-yellow-600 mt-0.5" />
            <div>
              <h4 className="font-semibold text-yellow-900">{t("clawCloud.prerequisites.accountRequirement.title")}</h4>
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("clawCloud.prerequisites.serviceFeatures.title")}</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.prerequisites.serviceFeatures.freeQuota.title")}</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.prerequisites.serviceFeatures.techSpecs.title")}</h4>
              <ul className="text-gray-600 space-y-1 text-sm">
      ...
      {/* Deployment Steps */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("clawCloud.deploymentSteps.title")}</h2>
        ...
        <div className="space-y-8">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.deploymentSteps.step4.startDeploy.title")}</h4>
                <p className="text-gray-700 mb-2">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <h5 className="font-semibold text-green-900">{t("clawCloud.deploymentSteps.step4.completed.title")}</h5>
        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start space-x-2">
                    <Info className="h-4 w-4 text-blue-600 mt-0.5" />
                    <div>
                      <h5 className="font-semibold text-blue-900">{t("clawCloud.accessUsage.firstAccess.login.securityTip.title")}</h5>
                      <p className="text-blue-800 text-sm">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.accessUsage.apiUsage.example.title")}</h4>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.updateMaintenance.versionUpdate.steps.title")}</h4>
                <div className="space-y-2 text-sm">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <h5 className="font-semibold text-green-900">{t("clawCloud.updateMaintenance.versionUpdate.autoUpdate.title")}</h5>
                    <p className="text-green-800 text-sm">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.updateMaintenance.monitoring.appMonitoring.title")}</h4>
                <ul className="text-gray-600 space-y-1 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t("clawCloud.updateMaintenance.monitoring.costControl.title")}</h4>
                <ul className="text-gray-600 space-y-1 text-sm">
      ...
      {/* Troubleshooting */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">{t("clawCloud.troubleshooting.title")}</h2>
        ...
        <div className="space-y-6">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800">{t("clawCloud.troubleshooting.commonIssues.appNotStart.title")}</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-800">{t("clawCloud.troubleshooting.commonIssues.authFailed.title")}</h4>
                <p className="text-gray-600 text-sm mb-2">
      ...
      <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t("clawCloud.nextSteps.title")}</h2>
        <p className="text-gray-700 mb-6">{t("clawCloud.nextSteps.description")}</p>
