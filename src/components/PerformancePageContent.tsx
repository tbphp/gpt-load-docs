...
export default function PerformancePageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">{t('performance.title')}</h1>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-6 text-center">
            <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-3">
              <Zap className="h-6 w-6 text-white" />
            </div>
            <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">{t('performance.coreFeatures.zeroIO.title')}</h3>
            <p className="text-blue-700 dark:text-blue-300 text-sm">{t('performance.coreFeatures.zeroIO.description')}</p>
          </div>

          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-6 text-center">
            <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-3">
              <Network className="h-6 w-6 text-white" />
            </div>
            <h3 className="font-semibold text-green-900 dark:text-green-200 mb-2">{t('performance.coreFeatures.zeroCopy.title')}</h3>
            <p className="text-green-700 dark:text-green-300 text-sm">{t('performance.coreFeatures.zeroCopy.description')}</p>
          </div>

          <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-6 text-center">
            <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-3">
              <Cpu className="h-6 w-6 text-white" />
            </div>
            <h3 className="font-semibold text-purple-900 dark:text-purple-200 mb-2">{t('performance.coreFeatures.lockFree.title')}</h3>
            <p className="text-purple-700 dark:text-purple-300 text-sm">{t('performance.coreFeatures.lockFree.description')}</p>
          </div>

          <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-900/30 border border-orange-200 dark:border-orange-700 rounded-lg p-6 text-center">
            <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-3">
              <MemoryStick className="h-6 w-6 text-white" />
            </div>
            <h3 className="font-semibold text-orange-900 dark:text-orange-200 mb-2">{t('performance.coreFeatures.lowResource.title')}</h3>
            <p className="text-orange-700 dark:text-orange-300 text-sm">{t('performance.coreFeatures.lowResource.description')}</p>
          </div>
        </div>
      </div>
      ...
      <section className="mb-12">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-6 mb-6">
            ...
            <div className="p-6">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900/20 rounded-lg p-4 mb-3">
                ...
                {/* 核心优势 */}
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">{t('performance.proxyPerformance.zeroCopyStreaming.advantages.title')}</h4>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <div className="flex items-start space-x-4">
              <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                <Timer className="h-5 w-5 text-purple-600 dark:text-purple-400 dark:text-purple-400" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">{t('performance.asyncTasks.massiveKeys.mechanism.title')}</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    {t('performance.asyncTasks.massiveKeys.mechanism.description')}
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">{t('performance.asyncTasks.massiveKeys.advantage.title')}</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">{t('performance.asyncTasks.clusterSupport.architecture.title')}</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    {t('performance.asyncTasks.clusterSupport.architecture.description')}
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">{t('performance.asyncTasks.clusterSupport.sync.title')}</h4>
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
          <MemoryStick className="h-7 w-7 text-purple-600 dark:text-purple-400 mr-3" />
          {t('performance.lightweight.title')}
        </h2>

        <div className="grid lg:grid-cols-2 gap-6">
          {/* 极低资源占用 */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-6">
            ...
            <div className="bg-purple-200 dark:bg-purple-900/30 rounded-lg p-3">
              <div className="flex items-center space-x-2">
                <Cpu className="h-4 w-4 text-purple-700 dark:text-purple-300 dark:text-purple-300" />
                <span className="text-purple-900 dark:text-purple-200 text-sm font-medium">
                  {t('performance.lightweight.lowResource.cpu')}
                </span>
              </div>
              <div className="flex items-center space-x-2 mt-1">
                <MemoryStick className="h-4 w-4 text-purple-700 dark:text-purple-300 dark:text-purple-300" />
                <span className="text-purple-900 dark:text-purple-200 text-sm font-medium">
          ...
          {/* 适用性广 */}
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-6">
